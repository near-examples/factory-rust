...
test("create_factory_subaccount_and_deploy tests", async (t) => {
  ...
  let create = await alice.call(factory, "create_factory_subaccount_and_deploy", { "name": `sub`, "beneficiary": beneficiary }, { gas: "40000000000000", attachedDeposit: NEAR.parse("1.24 N").toString()});
